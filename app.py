...
def main():
    ...
    if selected=="Car Price Predictor":
        ...
        st.write("*Mandatory")
        ARAI_Certified_Mileage_input=st.text_input("ARAI_Certified_Mileage*","Type Here in Km/Litre ")
        Displacement_input=st.text_input("Displacement*","Type Here in cc")
        Power_input=st.text_input("Power*","Type Here in HP")
        Torque_input=st.text_input("Torque*","Type Here in Nm")
        Fuel_Tank_Capacity_input=st.text_input("Fuel_Tank_Capacity*","Type Here in liters")
        Height_input=st.text_input("Height*","Type Here in mm")
        Length_input=st.text_input("Length*","Type Here in mm")
        Width_input=st.text_input("Width*","Type Here in mm")
        Doors_input=st.text_input("Doors*","Type Here in mm")
        Seating_Capacity_input=st.text_input("Seating_Capacity*","Type Here")
        Wheelbase_input=st.text_input("Wheelbase*","Type Here in mm")
